...
{
    UIBezierPath *maskPathCancel = [UIBezierPath bezierPathWithRoundedRect:self.bounds byRoundingCorners:corner cornerRadii:CGSizeMake(corRadius, corRadius)];
    CAShapeLayer *maskLayerCancel = [[CAShapeLayer alloc] init];
    maskLayerCancel.frame = self.bounds;
    maskLayerCancel.path = maskPathCancel.CGPath;
    self.layer.mask = maskLayerCancel;
}
@end
